...
----------------------------------------------------
--Hostile
minetest.register_entity("wm_mobs:t4_droid_hostile",{
	...
	lung_capacity = 160, 		-- seconds
	max_hp = minetest.PLAYER_MAX_HP_DEFAULT * 5,
	...
	view_range = 50,					-- nodes/meters
	swarm_d = 3,				-- distance between droids
	attack={range=0.5,damage_groups={fleshy=11}},
	armor_groups = {fleshy=85},
	weapon = "wm_weapons:t4_hunter",
...
wm_mobs.register_egg("wm_mobs:t4_droid_hostile", "Hostile T4 Droid", "wm_mobs_spawn_egg_t4.png", 0)
...
----------------------------------------------------
--Friendly
minetest.register_entity("wm_mobs:t4_droid_friendly",{
	-- required minetest api props
	team = "friendly",
	level = 4,
	physical = true,
...
wm_mobs.register_egg("wm_mobs:t4_droid_friendly", "Friendly T4 Droid", "wm_mobs_spawn_egg_t4.png", 0)
