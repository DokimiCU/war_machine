...
----------------------------------------------------
--Hostile
minetest.register_entity("wm_mobs:t2_droid_hostile",{
	...
	lung_capacity = 40, 		-- seconds
	max_hp = minetest.PLAYER_MAX_HP_DEFAULT * 2,
	...
	springiness= 0,
	max_speed = 2.5,					-- m/s
	jump_height = 2.3,				-- nodes/meters
	view_range = 40,					-- nodes/meters
	swarm_d = 5,				-- distance between droids
	attack={range=0.4,damage_groups={fleshy=4}},
	armor_groups = {fleshy=95},
	weapon = "wm_weapons:t2_machinepistol",
...
wm_mobs.register_egg("wm_mobs:t2_droid_hostile", "Hostile T2 Droid", "wm_mobs_spawn_egg_t2.png", 0)
...
----------------------------------------------------
--Friendly
minetest.register_entity("wm_mobs:t2_droid_friendly",{
	-- required minetest api props
	team = "friendly",
	level = 2,
	physical = true,
...
wm_mobs.register_egg("wm_mobs:t2_droid_friendly", "Friendly T2 Droid", "wm_mobs_spawn_egg_t2.png", 0)
